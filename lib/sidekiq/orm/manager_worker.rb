    ...
    module ManagerWorker
      ...
      module ClassMethods
        ...
        def perform_query_async(models_query, options = {})
          ...
          models_query = setup_collection(models_query)
        ...
        # Override this method in specific ORM gem
        def setup_collection(models_query)
          models_query.select(selected_attributes)
        end

        # Override this method in specific ORM gem
        def run_query(models_query)
          models_query.find_in_batches(batch_size: batch_size)
        end
